...
class GraphNode extends GraphComp {
     ...
     * Assume no more than 8 possible color and they are defined in
     * ThreeTenColor.COLORS.
     * nbrColorFlag[i] == 1: this node has a nbr taking color
     * ThreeTenColor.COLORS[i]
     * nbrColorFlag[i] == 0: this node has no nbr taking color
     * ThreeTenColor.COLORS[i]
     */
    ...
    /**
     * One neighbor of this node has been assigned color
     * ThreeTenColor.COLORS[index].
     ...
     * @return return true if there is a neighbor of this node taken the color;
     *         false otherwise
     */
